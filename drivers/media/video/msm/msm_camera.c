	...
	unsigned long arg)
{
	...
	case MSM_CAM_IOCTL_GET_CAMERA_INFO:
		...
		break;
#if defined(CONFIG_MACH_TASS) || defined(CONFIG_MACH_BENI) || defined(CONFIG_MACH_LUCAS) || defined (CONFIG_MACH_GIO) || defined(CONFIG_MACH_CALLISTO) || defined(CONFIG_MACH_EUROPA)
